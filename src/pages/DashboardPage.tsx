...
import { Gauge, Smile, MessageCircle, CheckCircle, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const DashboardPage: React.FC = () => {
  ...
  }, [validResults, coherenceFilter, politenessFilter, relevanceFilter, resolutionFilter]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#f8fafc] via-[#e8ecf3] to-[#f5f7fa] dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-8 px-2 md:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 max-w-7xl mx-auto">
        <ScoreCard
          title="Coherence"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {/* Score Distributions - Spans 2 columns on large screens */}
        <Card className="rounded-3xl bg-white/60 dark:bg-gray-800/90 dark:shadow-2xl shadow-xl p-6 lg:col-span-2">
          ...
          <CardContent className="pt-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {[
                ...
                <div key={index} className="h-[200px] bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-md flex flex-col justify-between">
                  <h4 className="text-base font-semibold mb-2 text-center text-app-text dark:text-gray-100">{chart.title}</h4>
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={chart.data} margin={{ top: 10, right: 10, left: 5, bottom: 15 }}>
                      <CartesianGrid 
                        strokeDasharray="3 3" 
                        vertical={false} 
        ...
        <Card className="rounded-3xl bg-white dark:bg-gray-900 shadow-xl p-6 flex flex-col justify-between border-0">
          <CardHeader className="pb-2">
        ...
        {/* Performance by Scenario - Spans 2 columns */}
        <Card className="rounded-3xl bg-white/60 dark:bg-gray-800/90 dark:shadow-2xl shadow-xl p-6 lg:col-span-2">
          <CardHeader className="pb-2">
            <CardTitle className="text-2xl font-bold text-app-text dark:text-gray-100">Performance by Scenario</CardTitle>
            <CardDescription className="text-base text-app-text-secondary dark:text-gray-300">Resolution rates and average scores across different scenarios</CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
        ...
        {/* Quick Actions Card */}
        <Card className="rounded-3xl bg-white/60 dark:bg-gray-800/90 dark:shadow-2xl shadow-xl p-6 flex flex-col justify-between">
          <CardHeader className="pb-2">
        ...
        {/* Chatlogs Table - Spans full width */}
        <Card className="rounded-3xl bg-white/60 dark:bg-gray-900/80 dark:shadow-2xl shadow-xl p-6 lg:col-span-3">
          <CardHeader className="pb-2">
          ...
          <CardContent className="pt-4">
              ...
              <div className="[&_th]:bg-white/60 dark:[&_th]:bg-gray-800/80 [&_th]:text-muted-foreground dark:[&_th]:text-gray-100 [&_th]:font-medium [&_th]:text-base [&_th]:border-border/40 dark:[&_th]:border-gray-700 [&_td]:border-border/40 dark:[&_td]:border-gray-700 [&_tr:hover]:bg-white/80 dark:[&_tr:hover]:bg-gray-800/60">
                <DataTable 
                  ...
                  data={paginatedData.map((item, index) => ({
                    ...item,
                    expandedContent: expandedChatlogIndex === (startIndex + index) ? (
                  ...
                  expandedRowIndex={expandedChatlogIndex !== null ? expandedChatlogIndex - startIndex : null}
                  onRowExpand={(index) => handleToggleChatlogView(index !== null ? index + startIndex : null)}
            ...
            {/* Pagination Controls */}
            {pageCount > 1 && (
              <div className="flex items-center justify-between mt-4 pt-4 pb-2 border-t dark:border-gray-700">
